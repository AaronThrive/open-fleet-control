  ...
  "src/secrets.js"(exports2, module2) {
    ...
    function createSecrets({
      ...
      function deepWalk(node, allowKeys, path2, failures, resolveValue) {
        if (Array.isArray(node)) {
          return node.map((item, i) => deepWalk(item, allowKeys, `${path2}[${i}]`, failures, resolveValue));
        }
        if (node !== null && typeof node === "object") {
          const out = {};
        ...
        (function collect(node) {
          ...
          if (node !== null && typeof node === "object") {
            for (const [key, value2] of Object.entries(node)) {
              if (typeof value2 === "string" && keyAllowlist.includes(key) && isSecretRef(value2)) {
...
var require_jobs = __commonJS({
  "src/jobs.js"(exports2, module2) {
    ...
    module2.exports = { handleJobsRequest: handleJobsRequest2, isJobsRoute: isJobsRoute2, setCronFallback: setCronFallback2, _resetForTesting };
  }
});
...
var require_cron = __commonJS({
  "src/cron.js"(exports2, module2) {
    ...
    function getHermesRawJobs(hermesCronPath) {
      const target = hermesCronPath || path2.join(os.homedir(), ".hermes", "cron", "jobs.json");
  ...
  "src/llm-usage.js"(exports2, module2) {
    ...
    function refreshRoutingStatsAsync(skillsPath, hours) {
      ...
      execFile(
        ...
        { encoding: "utf8", timeout: 1e4, cwd: skillDir, env: getSafeEnv() },
        (err, stdout) => {
...
var require_alerts_history = __commonJS({
  "src/alerts-history.js"(exports2, module2) {
    ...
    module2.exports = { createAlertHistory, MAX_QUERY_LIMIT };
  }
});
...
var require_alerts = __commonJS({
  "src/alerts.js"(exports2, module2) {
    var crypto = require("crypto");
    var { createAlertHistory } = require_alerts_history();
    var SEVERITIES = /* @__PURE__ */ new Set(["info", "warn", "critical"]);
    ...
    module2.exports = { createAlerts, createNodeAlertTracker, normalizeFlapConfig };
  }
});
...
`);
      ...
      function pruneState(currentKeys) {
        ...
        if (changed) state2 = { ...state2, fired: next };
        return changed;
      }
    ...
    function createUsageProvider({ usageSources: usageSources2 }) {
...
var require_fleet = __commonJS({
  "src/fleet.js"(exports2, module2) {
    ...
    var { createAlerts, createNodeAlertTracker } = require_alerts();
...
var require_fleet_routes = __commonJS({
  "src/fleet-routes.js"(exports2, module2) {
    ...
    function createFleetRoutes2({ fleet: fleet2, settings: settings2 = null, dispatch = null, rosterFn = null }) {
      ...
      async function handleKanbanDispatch(req, res, method, taskId, query) {
        ...
        if (preview) {
          ...
          json(res, 200, { preview: true, ...dispatch.previewDispatch(taskId, body2) });
          return true;
        }
        const user = guardMutation(req, res);
        if (!user) return true;
...
var require_settings = __commonJS({
  "src/settings.js"(exports2, module2) {
    ...
    function createSettings2({ configPath, onChange, onBudgetsChange } = {}) {
  ...
  "src/agents-roster.js"(exports2, module2) {
    ...
    function createAgentsRoster2(options = {}) {
      ...
      const hermesAgents = options.hermesAgents && typeof options.hermesAgents.listAgents === "function" ? options.hermesAgents : source === "hermes" ? createHermesAgents({
        hermesDir: typeof agentsConfig.hermesDir === "string" && agentsConfig.hermesDir || path2.join(os.homedir(), ".hermes"),
        nowFn
      }) : null;
      let fleetCache = null;
      function timeoutSignal(ms) {
...
var { handleJobsRequest, isJobsRoute, setCronFallback } = require_jobs();
...
var server = http.createServer((req, res) => {
  ...
  if (pathname === "/api/status") {
    ...
    const user = typeof login === "string" && login.trim().length > 0 ? login.trim().toLowerCase() : "anonymous";
