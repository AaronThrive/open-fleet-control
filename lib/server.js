...
var require_config = __commonJS({
  "src/config.js"(exports2, module2) {
    ...
    function buildFleetConfig(fileFleet) {
      ...
      return { ...fleet2, ...resolvedDirs, cortex: resolvedCortex };
    }
    function loadConfig() {
...
var require_tailscale = __commonJS({
  "src/tailscale.js"(exports2, module2) {
    ...
    function createTailscaleAdapter(deps = {}) {
      const {
        execFn = (cmd) => runCmd(cmd, { timeout: 5e3 }),
...
${res.stderr}`.trim().split("\n")[0]?.slice(0, 200) || "no output";
      ...
      async function getGraph({ limit = DEFAULT_GRAPH_LIMIT } = {}) {
        ...
        if (linksRes.error) {
          ...
          const links = Array.isArray(linkPayload) ? linkPayload : Array.isArray(linkPayload?.links) ? linkPayload.links : null;
          if (links) {
    ...
    module2.exports = { createGbrain, parseJsonOutput };
  }
});
...
var require_fleet_routes = __commonJS({
  "src/fleet-routes.js"(exports2, module2) {
    ...
    function createFleetRoutes2({ fleet: fleet2 }) {
...
var fleetRoutes = createFleetRoutes({ fleet });
