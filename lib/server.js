...
var require_actions = __commonJS({
  "src/actions.js"(exports2, module2) {
    ...
    async function executeAction2(action, deps, opts = {}) {
      ...
      if (typeof runOpenClawAsync2 !== "function") {
    ...
    function createDispatch2(options = {}) {
      ...
      function handleRunSettled(taskId, attemptIndex, agent, settled, startedMs) {
        if (settled.ok) {
          ...
          closeAttempt(taskId, attemptIndex, { result: "success", note: noteParts.join(" \xB7 ") });
      ...
      function dispatchTask(taskId, opts = {}) {
        ...
        let settledPromise;
        try {
          settledPromise = Promise.resolve(run(args2, { timeoutMs: timeoutSec * 1e3 + 5e3 })).then(
